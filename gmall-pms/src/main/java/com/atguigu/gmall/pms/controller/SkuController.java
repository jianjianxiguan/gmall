...
public class SkuController {
    ...
    public ResponseVo<List<SkuEntity>> querySkuFromSpu(@PathVariable("spuId")Long spuId){
        List<SkuEntity> entityList = skuService.list(new QueryWrapper<SkuEntity>().eq("spu_id",spuId));
